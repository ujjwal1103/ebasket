...
const Navbar = ({setQuery,dark,setDark}) => {
  ...
  return (
    <div className="h-16 bg-white dark:bg-gray-700 z-50 flex p-2 sticky top-0 items-center border-b-2 dark:border-gray-800 drop-shadow-lg">
      {navbar && (
                ...
                >
                  ...
                  >
                    <ul className="bg-white rounded-md mt-4 py-2">
                      ...
                      <li className="px-2 py-2 hover:bg-slate-100 " onClick={()=>setDark(!dark)}>
